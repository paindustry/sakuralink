...
class Tours extends CI_Controller {
	...
	function update($tour_id)
    {
    	$data = $_POST;
    	$this->tour->update_tour($tour_id, $data);
    	redirect(base_url() . 'index.php/admin/tour');
    }
	...
	function add_tour(){
		...
		else
		{
			...
			$this->session->set_flashdata('message', 'Paket Wisata Berhasil Di Tambahkan');
	...
	function delete_tour($id){
		$this->load->model('tour');
		$this->session->set_flashdata('message', 'Paket Berhasil Di Hapus');
